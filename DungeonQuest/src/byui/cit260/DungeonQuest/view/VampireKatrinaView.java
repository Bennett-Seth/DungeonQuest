 ...
 * @author parrdyl
 */
public class VampireKatrinaView extends View{
    ...
    public void fightMoster() {
        ...
        Inventory[] inventory = game.getInventory();
            ...
            this.console.println("But wait! Katrina has dropped "
                        + "the Viking Axe. Do you want to "
